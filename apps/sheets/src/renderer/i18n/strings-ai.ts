import { defineStrings } from '@fractal-office/i18n'
...
export const aiStrings = defineStrings({
  zh: {
    ...
    aiCodexAccount: 'Codex 账号',
    aiAccountChecking: '检测中…',
    aiLoggedIn: '已登录',
    aiLoggedInAs: '已登录：{email}',
    aiNotLoggedIn: '未登录（AI 功能需要登录 Codex 账号）',
    aiWaitingBrowserLogin: '等待浏览器登录…',
    aiLoginCodex: '登录 Codex',
    aiModel: '模型',
    aiCancel: '取消',
    aiSave: '保存',
    aiUnknownError: '未知错误',
  ...
  en: {
    ...
    aiCodexLoginBtn: 'Sign in to Codex',
    ...
    aiNotLoggedIn: 'Not signed in (AI features require a Codex account)',
    aiWaitingBrowserLogin: 'Waiting for browser sign-in…',
    aiLoginCodex: 'Sign in to Codex',
    aiModel: 'Model',
    aiCancel: 'Cancel',
    aiSave: 'Save',
  ...
  ja: {
    ...
    aiCodexAccount: 'Codex アカウント',
    aiAccountChecking: '確認中…',
    aiLoggedIn: 'サインイン済み',
    aiLoggedInAs: 'サインイン済み: {email}',
    aiNotLoggedIn: '未サインイン（AI 機能には Codex アカウントへのサインインが必要です）',
    aiWaitingBrowserLogin: 'ブラウザーでのサインインを待機中…',
    aiLoginCodex: 'Codex にサインイン',
    aiModel: 'モデル',
    aiCancel: 'キャンセル',
    aiSave: '保存',
  ...
  ko: {
    ...
    aiCodexAccount: 'Codex 계정',
    aiAccountChecking: '확인 중…',
    aiLoggedIn: '로그인됨',
    aiLoggedInAs: '로그인됨: {email}',
    aiNotLoggedIn: '로그인되지 않음(AI 기능을 사용하려면 Codex 계정 로그인이 필요합니다)',
    aiWaitingBrowserLogin: '브라우저 로그인 대기 중…',
    aiLoginCodex: 'Codex 로그인',
    aiModel: '모델',
    aiCancel: '취소',
    aiSave: '저장',
  ...
  fr: {
    ...
    aiCodexLoginBtn: 'Se connecter à Codex',
    ...
    aiCodexAccount: 'Compte Codex',
    aiAccountChecking: 'Vérification…',
    aiLoggedIn: 'Connecté',
    aiLoggedInAs: 'Connecté : {email}',
    aiNotLoggedIn: 'Non connecté (les fonctions IA nécessitent un compte Codex)',
    aiWaitingBrowserLogin: 'En attente de la connexion dans le navigateur…',
    aiLoginCodex: 'Se connecter à Codex',
    aiModel: 'Modèle',
    aiCancel: 'Annuler',
    aiSave: 'Enregistrer',
  ...
  de: {
    ...
    aiCodexLoginBtn: 'Bei Codex anmelden',
  ...
  es: {
    ...
    aiCodexLoginBtn: 'Iniciar sesión en Codex',
  ...
  th: {
    ...
    aiCodexLoginBtn: 'ลงชื่อเข้าใช้ Codex',
  ...
  id: {
    ...
    aiCodexLoginBtn: 'Masuk ke Codex',
  ...
  ru: {
    ...
    aiCodexAccount: 'Учётная запись Codex',
    aiAccountChecking: 'Проверка…',
    aiLoggedIn: 'Вход выполнен',
    aiLoggedInAs: 'Вход выполнен: {email}',
    aiNotLoggedIn: 'Вход не выполнен (для функций ИИ требуется учётная запись Codex)',
    aiWaitingBrowserLogin: 'Ожидание входа в браузере…',
    aiLoginCodex: 'Войти в Codex',
    aiModel: 'Модель',
    aiCancel: 'Отмена',
    aiSave: 'Сохранить',
  ...
  ar: {
    ...
    aiCodexLoginBtn: 'تسجيل الدخول إلى Codex',
  ...
  pt: {
    ...
    aiCodexLoginBtn: 'Entrar no Codex',
  ...
  it: {
    ...
    aiCodexLoginBtn: 'Accedi a Codex',
  ...
  pl: {
    ...
    aiCodexLoginBtn: 'Zaloguj się do Codex',
  ...
  nl: {
    ...
    aiCodexLoginBtn: 'Aanmelden bij Codex',
    ...
    aiNotLoggedIn: 'Niet aangemeld (AI-functies vereisen een Codex-account)',
    aiWaitingBrowserLogin: 'Wachten op aanmelding in de browser…',
    aiLoginCodex: 'Aanmelden bij Codex',
    aiModel: 'Model',
    aiCancel: 'Annuleren',
    aiSave: 'Opslaan',
  ...
  ms: {
    ...
    aiCodexLoginBtn: 'Log masuk ke Codex',
  ...
  he: {
    ...
    aiCodexAccount: 'חשבון Codex',
    aiAccountChecking: 'בודק…',
    aiLoggedIn: 'מחובר',
    aiLoggedInAs: 'מחובר: {email}',
    aiNotLoggedIn: 'לא מחובר (תכונות AI דורשות חשבון Codex)',
    aiWaitingBrowserLogin: 'ממתין לכניסה בדפדפן…',
    aiLoginCodex: 'כניסה ל-Codex',
    aiModel: 'מודל',
    aiCancel: 'ביטול',
    aiSave: 'שמירה',
  ...
  hi: {
    ...
    aiCodexLoginBtn: 'Codex में साइन इन करें',
  ...
  'zh-TW': {
    ...
    aiCodexAccount: 'Codex 帳號',
    aiAccountChecking: '偵測中…',
    aiLoggedIn: '已登入',
    aiLoggedInAs: '已登入：{email}',
    aiNotLoggedIn: '未登入（AI 功能需要登入 Codex 帳號）',
    aiWaitingBrowserLogin: '等待瀏覽器登入…',
    aiLoginCodex: '登入 Codex',
    aiModel: '模型',
    aiCancel: '取消',
    aiSave: '儲存',
    aiUnknownError: '未知錯誤',
