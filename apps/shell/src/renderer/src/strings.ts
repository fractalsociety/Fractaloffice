...
export const strings = {
  zh: {
    ...
    // Quick start
    newDoc: 'AI Docs',
    newSheet: 'Fractal Office Sheets',
    newSlide: 'Fractal Office Slides',
    openLocal: '打开本地文件',
    greetMorning: '早上好',
    greetAfternoon: '下午好',
    greetEvening: '晚上好',
    ...
    noContent: '（无内容）',
    // Account
    accountCodex: 'Codex 账号',
    account: '账号',
    login: '登录',
    loginCodex: '登录 Codex 账号',
    loggedIn: '已登录',
    loggedInCodex: '已登录 Codex',
    ...
    onbTitle1: '欢迎使用 Fractal Office',
    onbSubtitle1: '第一个开源的 AI 原生 Office 套件',
    onbBody1: '创建文档、制作表格、生成演示、审阅 PDF。AI 深度融入每个环节。',
    onbTitle2: '这只是一个开始',
    onbBody2: 'Fractal Office 目前处于 alpha 阶段。加入 Fractal Office Community 群聊，一起交流。',
    onbCredits: '活跃贡献者可获得 **1,000+ Codex 积分**',
    onbSkip: '跳过',
    onbNext: '下一步',
    onbStart: '开始使用',
  ...
  en: {
    ...
    untitled: 'Untitled',
    noContent: '(empty)',
    accountCodex: 'Codex Account',
    account: 'Account',
    login: 'Sign in',
    loginCodex: 'Sign in with Codex',
    loggedIn: 'Signed in',
    loggedInCodex: 'Signed in to Codex',
    ...
    newTab: 'New tab',
    // First-run onboarding
    onbTitle1: 'Welcome to Fractal Office',
    ...
    onbBody2: 'Fractal Office is still in alpha. Join the group chat on Fractal Office Community.',
    onbCredits: 'Active contributors get **1,000+ Codex credits**',
    onbSkip: 'Skip',
    onbNext: 'Next',
    ...
    onbNote3: 'AI features may consume Codex credits.',
    onbBack: 'Back',
  },
  ja: {
    // Sidebar navigation
    ...
    noContent: '（内容なし）',
    // Account
    accountCodex: 'Codex アカウント',
    account: 'アカウント',
    login: 'サインイン',
    loginCodex: 'Codex アカウントでサインイン',
    loggedIn: 'サインイン済み',
    loggedInCodex: 'Codex にサインイン済み',
    waitingLogin:
    ...
    newTab: '新しいタブ',
    // First-run onboarding
    onbTitle1: 'Fractal Office へようこそ',
    onbSubtitle1: '初のオープンソース AI ネイティブ Office スイート',
    onbBody1:
      '文書の作成、表計算、プレゼン作成、PDF のレビュー。あらゆるステップに AI が組み込まれています。',
    onbTitle2: 'これはまだ始まりにすぎません',
    onbBody2:
      'Fractal Office はまだアルファ版です。Fractal Office Community のグループチャットに参加しましょう。',
    onbCredits: 'アクティブな貢献者への特典 **1,000+ Codex クレジット**',
    onbSkip: 'スキップ',
    onbNext: '次へ',
    onbStart: 'はじめる',
    ...
    onbNote3: 'AI 機能は Codex クレジットを消費する場合があります。',
    onbBack: '戻る',
  },
  ko: {
    // Sidebar navigation
    ...
    noContent: '(내용 없음)',
    // Account
    accountCodex: 'Codex 계정',
    account: '계정',
    login: '로그인',
    loginCodex: 'Codex 계정으로 로그인',
    loggedIn: '로그인됨',
    loggedInCodex: 'Codex에 로그인됨',
    ...
    newTab: '새 탭',
    // First-run onboarding
    onbTitle1: 'Fractal Office에 오신 것을 환영합니다',
    onbSubtitle1: '최초의 오픈소스 AI 네이티브 오피스 제품군',
    onbBody1:
      '문서 작성, 스프레드시트 제작, 프레젠테이션 생성, PDF 검토. 모든 단계에 AI가 녹아 있습니다.',
    onbTitle2: '이제 시작일 뿐입니다',
    onbBody2:
      'Fractal Office는 아직 알파 단계입니다. Fractal Office Community 그룹 채팅에 참여해 보세요.',
    onbCredits: '활발한 기여자를 위한 혜택 **1,000+ Codex 크레딧**',
    onbSkip: '건너뛰기',
    onbNext: '다음',
    onbStart: '시작하기',
    ...
    onbNote3: 'AI 기능은 Codex 크레딧을 소모할 수 있습니다.',
    onbBack: '이전',
  },
  fr: {
    // Sidebar navigation
    ...
    noContent: '(vide)',
    // Account
    accountCodex: 'Compte Codex',
    account: 'Compte',
    login: 'Se connecter',
    loginCodex: 'Se connecter avec Codex',
    loggedIn: 'Connecté',
    loggedInCodex: 'Connecté à Codex',
    waitingLogin:
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenue dans Fractal Office',
    ...
    onbBody2:
      'Fractal Office est encore en alpha. Rejoignez la discussion de groupe sur Fractal Office Community.',
    onbCredits: 'Les contributeurs actifs reçoivent **1 000+ crédits Codex**',
    onbSkip: 'Passer',
    onbNext: 'Suivant',
    onbStart: 'Commencer',
    ...
    onbNote3: 'Les fonctions IA peuvent consommer des crédits Codex.',
    onbBack: 'Retour',
  },
  de: {
    // Sidebar navigation
    ...
    noContent: '(leer)',
    // Account
    accountCodex: 'Codex-Konto',
    account: 'Konto',
    login: 'Anmelden',
    loginCodex: 'Mit Codex anmelden',
    loggedIn: 'Angemeldet',
    loggedInCodex: 'Bei Codex angemeldet',
    waitingLogin:
    ...
    newTab: 'Neuer Tab',
    // First-run onboarding
    onbTitle1: 'Willkommen bei Fractal Office',
    ...
    onbBody2:
      'Fractal Office ist noch in der Alpha-Phase. Treten Sie dem Gruppenchat auf Fractal Office Community bei.',
    onbCredits: 'Aktive Mitwirkende erhalten **1.000+ Codex-Guthaben**',
    ...
    onbNote3: 'KI-Funktionen können Codex-Credits verbrauchen.',
    onbBack: 'Zurück',
  },
  es: {
    // Sidebar navigation
    ...
    noContent: '(vacío)',
    // Account
    accountCodex: 'Cuenta de Codex',
    account: 'Cuenta',
    login: 'Iniciar sesión',
    loginCodex: 'Iniciar sesión con Codex',
    loggedIn: 'Sesión iniciada',
    loggedInCodex: 'Sesión iniciada en Codex',
    waitingLogin:
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenido a Fractal Office',
    ...
    onbBody2: 'Fractal Office aún está en alfa. Únete al chat grupal en Fractal Office Community.',
    onbCredits: 'Los colaboradores activos reciben **1.000+ créditos de Codex**',
    onbSkip: 'Omitir',
    onbNext: 'Siguiente',
    onbStart: 'Empezar',
    ...
    onbNote3: 'Las funciones de IA pueden consumir créditos de Codex.',
    onbBack: 'Atrás',
  },
  th: {
    // Sidebar navigation
    ...
    // Account
    accountCodex: 'บัญชี Codex',
    account: 'บัญชี',
    login: 'ลงชื่อเข้าใช้',
    loginCodex: 'ลงชื่อเข้าใช้ด้วย Codex',
    loggedIn: 'ลงชื่อเข้าใช้แล้ว',
    loggedInCodex: 'ลงชื่อเข้าใช้ Codex แล้ว',
    ...
    newTab: 'แท็บใหม่',
    // First-run onboarding
    onbTitle1: 'ยินดีต้อนรับสู่ Fractal Office',
    ...
    onbBody2: 'Fractal Office ยังอยู่ในช่วงอัลฟ่า เข้าร่วมแชทกลุ่มบน Fractal Office Community',
    onbCredits: 'ผู้มีส่วนร่วมอย่างต่อเนื่องจะได้รับ **เครดิต Codex กว่า 1,000**',
    onbSkip: 'ข้าม',
    onbNext: 'ถัดไป',
    ...
    onbNote3: 'ฟีเจอร์ AI อาจใช้เครดิต Codex',
    onbBack: 'ย้อนกลับ',
  },
  id: {
    // Sidebar navigation
    ...
    noContent: '(kosong)',
    // Account
    accountCodex: 'Akun Codex',
    account: 'Akun',
    login: 'Masuk',
    loginCodex: 'Masuk dengan Codex',
    loggedIn: 'Sudah masuk',
    loggedInCodex: 'Sudah masuk ke Codex',
    ...
    newTab: 'Tab baru',
    // First-run onboarding
    onbTitle1: 'Selamat datang di Fractal Office',
    ...
    onbBody2:
      'Fractal Office masih dalam tahap alpha. Gabung obrolan grup di Fractal Office Community.',
    onbCredits: 'Kontributor aktif mendapat **1.000+ kredit Codex**',
    onbSkip: 'Lewati',
    onbNext: 'Berikutnya',
    onbStart: 'Mulai',
    ...
    onbNote3: 'Fitur AI dapat menggunakan kredit Codex.',
    onbBack: 'Kembali',
  },
  ru: {
    // Sidebar navigation
    ...
    noContent: '(пусто)',
    // Account
    accountCodex: 'Учётная запись Codex',
    account: 'Учётная запись',
    login: 'Войти',
    loginCodex: 'Войти через Codex',
    loggedIn: 'Вход выполнен',
    loggedInCodex: 'Выполнен вход в Codex',
    ...
    // First-run onboarding
    onbTitle1: 'Добро пожаловать в Fractal Office',
    ...
    onbBody2:
      'Fractal Office пока в альфа-версии. Присоединяйтесь к групповому чату в Fractal Office Community.',
    onbCredits: 'Активные участники получают **1000+ кредитов Codex**',
    onbSkip: 'Пропустить',
    onbNext: 'Далее',
    onbStart: 'Начать',
    ...
    onbNote3: 'Функции ИИ могут расходовать кредиты Codex.',
    onbBack: 'Назад',
  },
  ar: {
    // Sidebar navigation
    ...
    noContent: '(فارغ)',
    // Account
    accountCodex: 'حساب Codex',
    account: 'الحساب',
    login: 'تسجيل الدخول',
    loginCodex: 'تسجيل الدخول باستخدام Codex',
    loggedIn: 'تم تسجيل الدخول',
    loggedInCodex: 'تم تسجيل الدخول إلى Codex',
    ...
    // First-run onboarding
    onbTitle1: 'مرحبًا بك في Fractal Office',
    ...
    onbBody2:
      'لا يزال Fractal Office في مرحلة ألفا. انضم إلى الدردشة الجماعية على Fractal Office Community.',
    onbCredits: 'يحصل المساهمون النشطون على **+1,000 من أرصدة Codex**',
    onbSkip: 'تخطي',
    onbNext: 'التالي',
    onbStart: 'ابدأ الآن',
    ...
    onbNote3: 'قد تستهلك ميزات الذكاء الاصطناعي أرصدة Codex.',
    onbBack: 'رجوع',
  },
  pt: {
    navRecent: 'Recentes',
    ...
    untitled: 'Sem título',
    noContent: '(vazio)',
    accountCodex: 'Conta Codex',
    account: 'Conta',
    login: 'Entrar',
    loginCodex: 'Entrar com a Codex',
    loggedIn: 'Conectado',
    loggedInCodex: 'Conectado à Codex',
    ...
    newTab: 'Nova guia',
    // First-run onboarding
    onbTitle1: 'Bem-vindo ao Fractal Office',
    ...
    onbBody2:
      'O Fractal Office ainda está em alfa. Entre no chat em grupo no Fractal Office Community.',
    onbCredits: 'Contribuidores ativos recebem **1.000+ créditos Codex**',
    onbSkip: 'Pular',
    onbNext: 'Avançar',
    onbStart: 'Começar',
    onbStepAria: 'Página {n} de {total}',
    ...
    onbNote3: 'Os recursos de IA podem consumir créditos Codex.',
    onbBack: 'Voltar',
  },
  it: {
    navRecent: 'Recenti',
    ...
    noContent: '(vuoto)',
    accountCodex: 'Account Codex',
    account: 'Account',
    login: 'Accedi',
    loginCodex: 'Accedi con Codex',
    loggedIn: 'Accesso effettuato',
    loggedInCodex: 'Accesso effettuato a Codex',
    ...
    newTab: 'Nuova scheda',
    // First-run onboarding
    onbTitle1: 'Benvenuto in Fractal Office',
    ...
    onbBody2:
      'Fractal Office è ancora in alpha. Unisciti alla chat di gruppo su Fractal Office Community.',
    onbCredits: 'I collaboratori attivi ricevono **1.000+ crediti Codex**',
    onbSkip: 'Salta',
    onbNext: 'Avanti',
    onbStart: 'Inizia',
    ...
    onbNote3: 'Le funzioni IA possono consumare crediti Codex.',
    onbBack: 'Indietro',
  },
  pl: {
    navRecent: 'Ostatnie',
    ...
    untitled: 'Bez tytułu',
    noContent: '(pusto)',
    accountCodex: 'Konto Codex',
    account: 'Konto',
    login: 'Zaloguj się',
    loginCodex: 'Zaloguj się przez Codex',
    loggedIn: 'Zalogowano',
    loggedInCodex: 'Zalogowano do Codex',
    waitingLogin:
    ...
    newTab: 'Nowa karta',
    // First-run onboarding
    onbTitle1: 'Witamy w Fractal Office',
    ...
    onbBody2:
      'Fractal Office jest wciąż w fazie alfa. Dołącz do czatu grupowego na Fractal Office Community.',
    onbCredits: 'Aktywni współtwórcy otrzymują **1000+ kredytów Codex**',
    onbSkip: 'Pomiń',
    onbNext: 'Dalej',
    onbStart: 'Rozpocznij',
    ...
    onbNote3: 'Funkcje AI mogą zużywać kredyty Codex.',
    onbBack: 'Wstecz',
  },
  nl: {
    navRecent: 'Recent',
    ...
    account: 'Account',
    login: 'Inloggen',
    loginCodex: 'Inloggen met Codex',
    loggedIn: 'Ingelogd',
    loggedInCodex: 'Ingelogd bij Codex',
    ...
    // First-run onboarding
    onbTitle1: 'Welkom bij Fractal Office',
    ...
    onbBody2:
      'Fractal Office is nog in alfa. Doe mee aan de groepschat op Fractal Office Community.',
    onbCredits: 'Actieve bijdragers krijgen **1.000+ Codex-credits**',
    onbSkip: 'Overslaan',
    onbNext: 'Volgende',
    ...
    onbNote3: 'AI-functies kunnen Codex-credits verbruiken.',
    onbBack: 'Terug',
  },
  ms: {
    navRecent: 'Terkini',
    ...
    noContent: '(kosong)',
    accountCodex: 'Akaun Codex',
    account: 'Akaun',
    login: 'Log masuk',
    loginCodex: 'Log masuk dengan Codex',
    loggedIn: 'Telah log masuk',
    loggedInCodex: 'Telah log masuk ke Codex',
    ...
    newTab: 'Tab baharu',
    // First-run onboarding
    onbTitle1: 'Selamat datang ke Fractal Office',
    ...
    onbTitle2: 'Ini baru permulaan',
    onbBody2:
      'Fractal Office masih dalam peringkat alfa. Sertai sembang kumpulan di Fractal Office Community.',
    onbCredits: 'Penyumbang aktif menerima **1,000+ kredit Codex**',
    onbSkip: 'Langkau',
    onbNext: 'Seterusnya',
    onbStart: 'Mula',
    ...
    onbNote3: 'Ciri AI mungkin menggunakan kredit Codex.',
    onbBack: 'Kembali',
  },
  he: {
    navRecent: 'אחרונים',
    ...
    untitled: 'ללא שם',
    noContent: '(ריק)',
    accountCodex: 'חשבון Codex',
    account: 'חשבון',
    login: 'התחברות',
    loginCodex: 'התחברות עם Codex',
    loggedIn: 'מחובר',
    loggedInCodex: 'מחובר ל-Codex',
    ...
    // First-run onboarding
    onbTitle1: 'ברוכים הבאים ל-Fractal Office',
    ...
    onbBody2: 'Fractal Office עדיין בגרסת אלפא. הצטרפו לצ׳אט הקבוצתי ב-Fractal Office Community.',
    onbCredits: 'תורמים פעילים מקבלים **1,000+ נקודות Codex**',
    onbSkip: 'דילוג',
    onbNext: 'הבא',
    onbStart: 'להתחיל',
    ...
    onbNote3: 'תכונות AI עשויות לצרוך קרדיטים של Codex.',
    onbBack: 'חזרה',
  },
  hi: {
    navRecent: 'हाल के',
    ...
    noContent: '(खाली)',
    accountCodex: 'Codex खाता',
    account: 'खाता',
    login: 'साइन इन करें',
    loginCodex: 'Codex से साइन इन करें',
    loggedIn: 'साइन इन हो गया',
    loggedInCodex: 'Codex में साइन इन है',
    waitingLogin:
    ...
    newTab: 'नया टैब',
    // First-run onboarding
    onbTitle1: 'Fractal Office में आपका स्वागत है',
    ...
    onbBody2: 'Fractal Office अभी अल्फ़ा में है। Fractal Office Community पर ग्रुप चैट से जुड़ें।',
    onbCredits: 'सक्रिय योगदानकर्ताओं के लिए **1,000+ Codex क्रेडिट**',
    onbSkip: 'छोड़ें',
    onbNext: 'आगे',
    onbStart: 'शुरू करें',
    ...
    onbNote3: 'AI सुविधाएँ Codex क्रेडिट खर्च कर सकती हैं।',
    onbBack: 'वापस',
  },
  'zh-TW': {
    navRecent: '最近',
    ...
    untitled: '未命名',
    noContent: '（無內容）',
    accountCodex: 'Codex 帳號',
    account: '帳號',
    login: '登入',
    loginCodex: '登入 Codex 帳號',
    loggedIn: '已登入',
    loggedInCodex: '已登入 Codex',
    ...
    newTab: '新分頁',
    // First-run onboarding
    onbTitle1: '歡迎使用 Fractal Office',
    onbSubtitle1: '第一個開源的 AI 原生 Office 套件',
    onbBody1: '建立文件、製作試算表、產生簡報、審閱 PDF。AI 深度融入每個環節。',
    onbTitle2: '這只是一個開始',
    onbBody2: 'Fractal Office 目前仍在 alpha 階段。加入 Fractal Office Community 群聊，一起交流。',
    onbCredits: '活躍貢獻者可獲得 **1,000+ Codex 點數**',
    onbSkip: '略過',
    onbNext: '下一步',
    onbStart: '開始使用',
