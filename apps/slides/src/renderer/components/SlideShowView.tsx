...
import type { RenderNode, RenderSlide, ShapeRenderNode } from '@fractal-office/pptx-render'
...
function ShowMediaLayer({
  ...
  const nodes = slide.nodes.filter(
    (n): n is import('@fractal-office/pptx-render').PictureRenderNode =>
      n.type === 'picture' &&
      !!(n as import('@fractal-office/pptx-render').PictureRenderNode).media,
  )
