...
/** office/pdf formats extract text via @fractal-office/file-parse; images skip text extraction and go multimodal (slides:files-read-image) */
...
/** Extract attachment text via @fractal-office/file-parse (docx/pdf/pptx/xlsx/plain text) */
