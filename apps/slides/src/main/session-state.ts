/**
 * Shared main-process state for Fractal Office Slides, extracted from slides-main.ts so
...
import { materializeSlide, type OpenedPptx, type Slide } from '@fractal-office/pptx-engine'
import {
  buildRenderSlide,
