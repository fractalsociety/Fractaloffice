...
import { addPicture, createBlankPptx, openPptx, savePptx } from '@fractal-office/pptx-engine'
import { buildRenderSlide, type PictureRenderNode } from '@fractal-office/pptx-render'
import {
  decodeInkPayload,
  encodeInkPayload,
  inkNodeHitTest,
