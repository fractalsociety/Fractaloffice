...
import {
  ...
  safeExternalUrl,
} from '@fractal-office/electron-utils'
import { createI18n, getUiLang, normalizeLang, setUiLang } from '@fractal-office/i18n'
import { ProjectStore } from '@fractal-office/project-store'
import type {
  IpcMainInvokeEvent,
...
import { parseFileToText } from '@fractal-office/file-parse'
import {
  defaultAiSettings,
  resolveAiSettings,
  type AiChatRequest,
...
import { chatForProvider, streamForProvider } from '@fractal-office/ai-provider/runtime'
...
const tMain = createI18n({
  zh: {
    ...
    errCodexNotLoggedIn: '未登录 Codex:请点击下方「登录 Codex」完成登录后重试',
    ...
    menuWindow: '窗口',
    menuHelp: '帮助',
    menuDocsHelp: 'Fractal Office Docs 帮助',
  },
  en: {
    ...
    menuWindow: 'Window',
    menuHelp: 'Help',
    menuDocsHelp: 'Fractal Office Docs Help',
  },
  ja: {
    dlgOpenDoc: '文書を開く',
    filterWord: 'Word 文書',
    ...
    menuWindow: 'ウィンドウ',
    menuHelp: 'ヘルプ',
    menuDocsHelp: 'Fractal Office Docs ヘルプ',
  },
  ko: {
    dlgOpenDoc: '문서 열기',
    filterWord: 'Word 문서',
    ...
    menuWindow: '창',
    menuHelp: '도움말',
    menuDocsHelp: 'Fractal Office Docs 도움말',
  },
  fr: {
    ...
    menuWindow: 'Fenêtre',
    menuHelp: 'Aide',
    menuDocsHelp: 'Aide Fractal Office Docs',
  },
  de: {
    ...
    menuWindow: 'Fenster',
    menuHelp: 'Hilfe',
    menuDocsHelp: 'Fractal Office Docs-Hilfe',
  },
  es: {
    ...
    menuWindow: 'Ventana',
    menuHelp: 'Ayuda',
    menuDocsHelp: 'Ayuda de Fractal Office Docs',
  },
  th: {
    ...
    menuWindow: 'หน้าต่าง',
    menuHelp: 'วิธีใช้',
    menuDocsHelp: 'วิธีใช้ Fractal Office Docs',
  },
  id: {
    ...
    errCodexNotLoggedIn: 'Belum masuk ke Codex: klik “Masuk ke Codex” di bawah, lalu coba lagi',
    ...
    menuWindow: 'Jendela',
    menuHelp: 'Bantuan',
    menuDocsHelp: 'Bantuan Fractal Office Docs',
  },
  ru: {
    ...
    menuWindow: 'Окно',
    menuHelp: 'Справка',
    menuDocsHelp: 'Справка Fractal Office Docs',
  },
  ar: {
    ...
    menuWindow: 'نافذة',
    menuHelp: 'تعليمات',
    menuDocsHelp: 'تعليمات Fractal Office Docs',
  },
  pt: {
    dlgOpenDoc: 'Abrir Documento',
    ...
    menuWindow: 'Janela',
    menuHelp: 'Ajuda',
    menuDocsHelp: 'Ajuda do Fractal Office Docs',
  },
  it: {
    ...
    menuWindow: 'Finestra',
    menuHelp: 'Aiuto',
    menuDocsHelp: 'Guida di Fractal Office Docs',
  },
  pl: {
    ...
    menuWindow: 'Okno',
    menuHelp: 'Pomoc',
    menuDocsHelp: 'Pomoc Fractal Office Docs',
  },
  nl: {
  ...
  he: {
    ...
    errCodexNotLoggedIn: 'לא מחובר ל-Codex: לחץ על "התחבר ל-Codex" למטה, התחבר ונסה שוב',
    ...
    menuWindow: 'חלון',
    menuHelp: 'עזרה',
    menuDocsHelp: 'עזרה של Fractal Office Docs',
  },
  hi: {
    ...
    menuWindow: 'विंडो',
    menuHelp: 'सहायता',
    menuDocsHelp: 'Fractal Office Docs सहायता',
  },
  'zh-TW': {
    dlgOpenDoc: '開啟文件',
    filterWord: 'Word 文件',
    ...
    errCodexNotLoggedIn: '未登入 Codex:請點擊下方「登入 Codex」完成登入後重試',
    ...
    menuWindow: '視窗',
    menuHelp: '說明',
    menuDocsHelp: 'Fractal Office Docs 說明',
  },
})
...
export function defaultSaveDir(): string {
  const dir = join(app.getPath('documents'), 'Fractal Office')
...
/** office/pdf formats get text extracted via @fractal-office/file-parse; images skip extraction and go multimodal (files:read-image) */
...
function savePastedImage(data: unknown, ext: unknown): string | null {
  ...
  const dir = join(app.getPath('temp'), 'fractal-office-pasted')
  mkdirSync(dir, { recursive: true })
...
/** parse an attachment to text via @fractal-office/file-parse (docx/pdf/pptx/xlsx/plain text) */
...
// implementations live in @fractal-office/ai-provider, shared with apps/sheets.
...
export function startDocsStandalone(): void {
  ...
  // the installed Fractal Office Docs is open and forwards its argv there instead.
  if (isDev) app.setPath('userData', join(app.getPath('appData'), 'Fractal Office Docs Dev'))
  ...
  app.whenReady().then(() => {
    setUiLang(normalizeLang(process.env.FRACTAL_OFFICE_LANG ?? app.getLocale()))
