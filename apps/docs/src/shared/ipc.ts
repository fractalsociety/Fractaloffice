...
// ---- AI provider settings/config/streaming: canonical types live in @fractal-office/ai-provider ----
...
// ---- agent protocol: canonical types live in @fractal-office/agent-core ----
...
export interface DesktopApi {
  ...
  /** Codex account status (codex login state); withEmail also returns the email (needs a network request, slower) */
