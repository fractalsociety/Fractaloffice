 ...
 * bundled — the codex CLI and its runtime deps are spawned, never imported, so
...
function bareName(spec) {
  ...
  if (BUILTIN.has(name) || name.startsWith('@fractal-office/')) return null
...
let out = `Fractal Office — Third-Party Software Notices
